...
export default function QuoteCard() {
  return (
    <Card className="bg-muted-foreground/3 group hover:border-muted-foreground/50 hover:bg-muted-foreground/8 col-span-1 gap-0 rounded-3xl px-0 py-0 transition-colors lg:col-span-2">
