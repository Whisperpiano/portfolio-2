...
export default function SocialLink({ social }: { social: Social }) {
  return (
    <Link
      ...
      href={social.href}
      target="_blank"
      className={`group relative aspect-square cursor-pointer rounded-3xl border transition-all duration-300 hover:border-transparent sm:aspect-auto sm:min-h-[150px] ${social.class} flex items-center justify-center overflow-hidden`}
    >
